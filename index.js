...
//Variables created to store the results.
...
for (let i = 0; i < finances.length; i++) {
  ...
  //calculates the totalProfitLoss by summing up all the profit/loss amounts.

  if (i > 0) {
    const profitChange = profitLoss - finances[i - 1][1];
